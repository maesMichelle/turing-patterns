...
const imgTexture = textureLoader.load("./img/vleugel.png", start);
...
gui.add(material.uniforms.udA, "value").min(0).max(1).step(0.001).name("dA");
gui.add(material.uniforms.udB, "value").min(0).max(1).step(0.001).name("dB");
gui
